...
RSpec.describe DoctorsController, type: :feature do
  context 'GET doctors controller views' do
    ...
    it 'Get #show action of a doctor as patient' do
      ...
      expect(page).to have_content(doctor.name.to_s)
    end
    ...
    it 'Get #show of a doctor as doctor' do
      visit new_doctor_session_path
      fill_in 'doctor_email', with: doctor.email
      fill_in 'doctor_password', with: doctor.password
      click_button 'Log in'
